...
const bgMap: Record<string, { url: string; accent: string; heading: string; blurb: string }> = {
  ...
  wildlife: { url: 'https://images.unsplash.com/photo-1546182990-dffeafbe841d?q=80&w=2000&auto=format&fit=crop', accent: '#FFB703', heading: 'Wildlife Results', blurb: 'Species tracking, biodiversity, and habitat updates.' },
