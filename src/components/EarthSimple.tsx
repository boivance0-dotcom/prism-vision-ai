...
interface EarthSimpleProps {
  className?: string;
  style?: React.CSSProperties;
}

const EarthSimple: React.FC<EarthSimpleProps> = ({ className = '', style = {} }) => {
  return (
    <div 
    ...
    >
      ...
      <div className="relative">
        {/* Main Earth Sphere */}
        <div
          className="w-64 h-64 rounded-full relative overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.6)] earth-spin"
          style={{
        ...
        {/* Orbital Ring */}
        <div
          className="absolute inset-0 rounded-full border-2 border-white/20 earth-ring"
          style={{ 
            margin: '-10px'
          }}
        />
